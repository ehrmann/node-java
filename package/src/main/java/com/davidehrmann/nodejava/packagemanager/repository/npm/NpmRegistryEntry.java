...
public class NpmRegistryEntry {
    ...
    public static class VersionInfo {
        ...
        public VersionInfo(
            ...
            this.dependencies = (dependencies != null ? dependencies : Collections.<String, VersionSpec>emptyMap()).entrySet().stream()
                    .filter(e -> e.getValue() != null)
                    .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

            this.devDependencies = (devDependencies != null ? devDependencies : Collections.<String, VersionSpec>emptyMap()).entrySet().stream()
                    .filter(e -> e.getValue() != null)
                    .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

            this.optionalDependencies = (optionalDependencies != null ? optionalDependencies : Collections.<String, VersionSpec>emptyMap()).entrySet().stream()
                    .filter(e -> e.getValue() != null)
                    .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
        }
