...
public interface PackageManager {
    ...
    void installPackageAndDependencies(String name, VersionSpec versionSpec, boolean devDependencies, boolean optionalDependencies) throws NoMatchingVersionException, IOException, NoMatchingPackageException, RepositoryException, FileStoreException, PackageManagerException;
