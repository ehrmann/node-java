...
public class SimplePackageManagerTest {
    ...
    public void testRealInstall() throws IOException, SQLException, NoMatchingVersionException, NoMatchingPackageException, RepositoryException, FileStoreException, PackageManagerException {
        ...
        packageManager.installPackageAndDependencies("express", VersionSpec.fromString("4.x"));
        packageManager.installPackageAndDependencies("express", VersionSpec.fromString("2.x"));
    ...
    public void installer() throws FileStoreException, RepositoryException, PackageManagerException, IOException, NoMatchingPackageException, NoMatchingVersionException, SQLException {
        ...
        packageManager.installPackageAndDependencies("less", VersionSpec.fromString("*"));
    }
}
